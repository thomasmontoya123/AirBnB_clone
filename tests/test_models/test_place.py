...
class TestPlace(unittest.TestCase):
    ...
    def setUpClass(cls):
        '''set up for test'''
        cls.place = Place()
        cls.place.city_id = "1234-MED"
        cls.place.user_id = "4321-MED"
        cls.place.name = "Ciudad del rio"
        cls.place.description = "LA PIEDRA"
        cls.place.number_rooms = 20000000
        cls.place.number_bathrooms = 1
        cls.place.max_guest = 807360
        cls.place.price_by_night = 100
        cls.place.latitude = 142234.0
        cls.place.longitude = 152234.0
        cls.place.amenity_ids = ["1324-perroa2k"]
